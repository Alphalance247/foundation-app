...
const VisionMissionValues = () => {
  return (
    <SlideInSection>
      <section className="bg-[#F4F7F9] py-16 px-6" id="mission">
        {/* Content */}
        <div className="text-start max-w-6xl mx-auto sm:text-center">
          {/* Heading */}
          <h2 className="text-2xl sm:text-5xl font-extrabold text-[#2A9D8F] mb-8">
            Our Vision, Mission, and Values
          </h2>
          <p className="text-base sm:text-xl text-gray-600 max-w-3xl mx-auto mb-12">
          ...
          <div className="gap-8 grid grid-cols-1 sm:grid-cols-3 sm:gap-2 lg:gap-8">
            {/* Vision */}
